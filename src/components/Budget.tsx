...
export default function Budget() {
  ...
  return (
    <div className="gradient w-[500px] h-[725px] flex flex-col items-center rounded-md relative m-4">
      <div className="bg-red-500 h-1/3 w-1/2 text-center">Graph</div>
      <div className="w-full flex flex-col items-center ">
        ...
        <div className="grid col-span-4 gap-3 w-[90%] text-center">
          ...
          {items.map((item, index) => (
            <div
              key={index}
              className="bg-[#559CB9] text-center border-4 grid grid-cols-subgrid col-span-4 border-transparent rounded-md"
            >
              <p>{item.priority}</p>
